...
<li><b>Featurewiz now runs with a default setting of `nrows=None`.</b> This means it will run using all rows. But if you want to run fast, then you need to change the input to `nrows=1000` so it will sample 1000 rows and run.
